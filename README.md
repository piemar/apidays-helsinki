...
3. Created an API Key inside that project, and recorded the public,for more information see https://www.mongodb.com/docs/atlas/configure-api-access/#create-an-api-key-for-a-project
